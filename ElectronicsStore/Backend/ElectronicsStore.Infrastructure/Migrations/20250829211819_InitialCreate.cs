        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingPhoneNumber = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    ...
                    ShippingCountry = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: "India"),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalTransactionId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    RazorpayOrderId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    RazorpayPaymentId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    RazorpaySignature = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    GatewayName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    ProcessorReference = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    CustomerId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Brands",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Description", "IsActive", "IsDeleted", "LogoUrl", "Name", "UpdatedAt", "UpdatedBy", "Website" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 29, 21, 16, 52, 846, DateTimeKind.Utc).AddTicks(18), null, "Premium technology products", true, false, null, "Apple", null, null, null },
                    { 2, new DateTime(2025, 8, 29, 21, 16, 52, 846, DateTimeKind.Utc).AddTicks(22), null, "Innovative electronic devices", true, false, null, "Samsung", null, null, null },
                    { 3, new DateTime(2025, 8, 29, 21, 16, 52, 846, DateTimeKind.Utc).AddTicks(24), null, "Smart devices and AI technology", true, false, null, "Google", null, null, null },
                    { 4, new DateTime(2025, 8, 29, 21, 16, 52, 846, DateTimeKind.Utc).AddTicks(27), null, "Entertainment and technology", true, false, null, "Sony", null, null, null },
                    { 5, new DateTime(2025, 8, 29, 21, 16, 52, 846, DateTimeKind.Utc).AddTicks(29), null, "Software and computing devices", true, false, null, "Microsoft", null, null, null },
                    { 6, new DateTime(2025, 8, 29, 21, 16, 52, 846, DateTimeKind.Utc).AddTicks(31), null, "Personal computers and laptops", true, false, null, "Dell", null, null, null },
                    { 7, new DateTime(2025, 8, 29, 21, 16, 52, 846, DateTimeKind.Utc).AddTicks(33), null, "Computing and printing solutions", true, false, null, "HP", null, null, null },
                    { 8, new DateTime(2025, 8, 29, 21, 16, 52, 846, DateTimeKind.Utc).AddTicks(35), null, "Smart devices for everyone", true, false, null, "Xiaomi", null, null, null }
                });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Description", "ImageUrl", "IsActive", "IsDeleted", "Name", "ParentCategoryId", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 29, 21, 16, 52, 845, DateTimeKind.Utc).AddTicks(8662), null, "Latest smartphones and mobile devices", null, true, false, "Smartphones", null, null, null },
                    { 2, new DateTime(2025, 8, 29, 21, 16, 52, 845, DateTimeKind.Utc).AddTicks(8693), null, "Laptops and notebooks", null, true, false, "Laptops", null, null, null },
                    { 3, new DateTime(2025, 8, 29, 21, 16, 52, 845, DateTimeKind.Utc).AddTicks(8696), null, "Tablets and iPads", null, true, false, "Tablets", null, null, null },
                    { 4, new DateTime(2025, 8, 29, 21, 16, 52, 845, DateTimeKind.Utc).AddTicks(8866), null, "Headphones, speakers and audio devices", null, true, false, "Audio", null, null, null },
                    { 5, new DateTime(2025, 8, 29, 21, 16, 52, 845, DateTimeKind.Utc).AddTicks(8869), null, "Gaming consoles and accessories", null, true, false, "Gaming", null, null, null },
                    { 6, new DateTime(2025, 8, 29, 21, 16, 52, 845, DateTimeKind.Utc).AddTicks(8871), null, "Smart home devices and IoT products", null, true, false, "Smart Home", null, null, null },
                    { 7, new DateTime(2025, 8, 29, 21, 16, 52, 845, DateTimeKind.Utc).AddTicks(8873), null, "Digital cameras and photography equipment", null, true, false, "Cameras", null, null, null },
                    { 8, new DateTime(2025, 8, 29, 21, 16, 52, 845, DateTimeKind.Utc).AddTicks(8875), null, "Smartwatches and fitness trackers", null, true, false, "Wearables", null, null, null }
                });
