  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
                  ...
                  >
                    <CardContent sx={{ flex: 1 }}>
                      ...
                      {(item.product?.stockQuantity ?? 0) > 0 &&
                        (item.product?.stockQuantity ?? 0) <= 5 && (
                          <Chip
                            label="Low Stock"
                            color="warning"
                            size="small"
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to remove "{itemToDelete?.product?.name}" from
            your wishlist?
          </Typography>
        </DialogContent>
        <DialogActions>
          ...
          <Button
            onClick={() =>
              itemToDelete && handleRemoveFromWishlist(itemToDelete)
            }
            color="error"
            variant="contained"
          >
      ...
      <Dialog open={bulkDeleteOpen} onClose={() => setBulkDeleteOpen(false)}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to remove {selectedItems.length} selected item
            {selectedItems.length !== 1 ? "s" : ""} from your wishlist?
          </Typography>
        </DialogContent>
        <DialogActions>
